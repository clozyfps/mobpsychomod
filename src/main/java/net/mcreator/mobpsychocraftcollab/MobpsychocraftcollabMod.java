 ...
 *
 */
package net.mcreator.mobpsychocraftcollab;
...
@Mod("mobpsychocraftcollab")
public class MobpsychocraftcollabMod {
	public static final Logger LOGGER = LogManager.getLogger(MobpsychocraftcollabMod.class);
	public static final String MODID = "mobpsychocraftcollab";
