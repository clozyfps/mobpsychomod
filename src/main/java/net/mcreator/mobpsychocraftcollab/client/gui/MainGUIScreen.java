...
public class MainGUIScreen extends AbstractContainerScreen<MainGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("mobpsychocraftcollab:textures/screens/main_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("mobpsychocraftcollab:textures/screens/gui9.png"));
		this.blit(ms, this.leftPos + -88, this.topPos + -37, 0, 0, 180, 243, 180, 243);
